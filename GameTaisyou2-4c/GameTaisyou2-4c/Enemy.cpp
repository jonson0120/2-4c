...
void Enemy::Draw(int x,int y) const {
	...
	DrawFormatString(0, 180, 0xffffff, "%d", enex - x + (SCREEN_WIDTH / 2));
	DrawFormatString(0, 195, 0xffffff, "%d", eney - y + (SCREEN_HEIGHT / 2));
	DrawFormatString(0, 210, 0xffffff, "%d", enex);
	DrawFormatString(0, 225, 0xffffff, "%d", eney);
}
